...
GLfloat camXforms[9] = {8.,7.,17.,0.,0.,-100.,0.,1.,0};
...
GLfloat camKeyFrameValues[15][9];
GLint camKeyFramePositions[15];
GLint camNumOfKeyFrames;
...
void SetKeyFrame(int kf, GLfloat keyframevalues[15][9], GLint *keyframepositions, GLint *numKF,
				 GLfloat Tx, GLfloat Ty, GLfloat Tz, GLfloat Sx, GLfloat Sy, GLfloat Sz, GLfloat Rx, GLfloat Ry, GLfloat Rz)
{
...
void Display(void)
{
	...
	EvaluateXformsAt(camKeyFrameValues, camKeyFramePositions, camNumOfKeyFrames, currentFrame, camXforms);
...
void init(void){
  ...
  //  glClearColor(0.0,0.0,0.0,0.0);
	...
	smNumOfKeyFrames = 0;
	// Bouncing Snowy
	SetKeyFrame(0,smKeyFrameValues, smKeyFramePositions, &smNumOfKeyFrames, -5.,7.,0.,1.,1.,1.,0.,40.,20.);
	SetKeyFrame(10,smKeyFrameValues, smKeyFramePositions, &smNumOfKeyFrames, 4.,0.,0.,0.8,1.2,1.,0.,40.,20.);
	SetKeyFrame(13,smKeyFrameValues, smKeyFramePositions, &smNumOfKeyFrames, 4.,0.,0.,1.2,0.8,1.,0.,40.,0.);
	SetKeyFrame(16,smKeyFrameValues, smKeyFramePositions, &smNumOfKeyFrames, 4.,0.,0.,0.8,1.2,1.,0.,40.,-20.);
	SetKeyFrame(26,smKeyFrameValues, smKeyFramePositions, &smNumOfKeyFrames, 8.,7.,0.,1.,1.,1.,0.,40.,-20.);
	SetKeyFrame(30,smKeyFrameValues, smKeyFramePositions, &smNumOfKeyFrames, 10.,7.,0.,1.,1.,1.,0.,40.,20.);
	SetKeyFrame(40,smKeyFrameValues, smKeyFramePositions, &smNumOfKeyFrames, 15.,0.,0.,0.8,1.2,1.,0.,40.,20.);
	
	//Cut, shot 2 no longer needed
//	SetKeyFrame(41,smKeyFrameValues, smKeyFramePositions, &smNumOfKeyFrames, 12.5,3.5,0.,0.9,1.1,1.,0.,40.,20.);
//	SetKeyFrame(47,smKeyFrameValues, smKeyFramePositions, &smNumOfKeyFrames, 15.,0.,0.,0.8,1.2,1.,0.,40.,20.);
	SetKeyFrame(50,smKeyFrameValues, smKeyFramePositions, &smNumOfKeyFrames, 15.,0.,0.,1.,1.,1.,0.,40.,0.);
	SetKeyFrame(62,smKeyFrameValues, smKeyFramePositions, &smNumOfKeyFrames, 15.,0.,0.,1.,1.,1.,0.,40.,0.);

	// Snowy in free fall
	SetKeyFrame(70,smKeyFrameValues, smKeyFramePositions, &smNumOfKeyFrames, 15.,-10.,0.,1,1.,1.,0.,40.,0.);

	// keyframes for the head
	SetKeyFrame(0,sheadKeyFrameValues, sheadKeyFramePositions, &sheadNumOfKeyFrames, 0.,0.,0.,1.,1.,1.,0.,0.,0.);
	SetKeyFrame(47,sheadKeyFrameValues, sheadKeyFramePositions, &sheadNumOfKeyFrames, 0.,0.,0.,1.,1.,1.,0.,0.,0.);
	SetKeyFrame(55,sheadKeyFrameValues, sheadKeyFramePositions, &sheadNumOfKeyFrames, 0.,0.,0.,1.,1.,1.,40.,-20.,0.);
	SetKeyFrame(57,sheadKeyFrameValues, sheadKeyFramePositions, &sheadNumOfKeyFrames, 0.,0.,0.,1.,1.,1.,0.,-20.,0.);
	SetKeyFrame(70,sheadKeyFrameValues, sheadKeyFramePositions, &sheadNumOfKeyFrames, 0.,0.,0.,1.,1.,1.,0.,-20.,0.);

	//keyframes for the eyes
	SetKeyFrame(0,seyeKeyFrameValues, seyeKeyFramePositions, &seyeNumOfKeyFrames, 0.,0.,0.,1.,1.,1.,0.,0.,0.);
	SetKeyFrame(55,seyeKeyFrameValues, seyeKeyFramePositions, &seyeNumOfKeyFrames, 0.,0.,0.,1.,1.,1.,0.,0.,0.);
	SetKeyFrame(57,seyeKeyFrameValues, seyeKeyFramePositions, &seyeNumOfKeyFrames, 0.,0.,0.,1.4,1.4,1.2,0.,0.,0.);
	SetKeyFrame(70,seyeKeyFrameValues, seyeKeyFramePositions, &seyeNumOfKeyFrames, 0.,0.,0.,1.4,1.4,1.2,0.,0.,0.);

	// keyframes for the hands
	SetKeyFrame(62,slHandKeyFrameValues, slHandKeyFramePositions, &slHandNumOfKeyFrames, 0.,0.,0.,1.,1.,1.,0.,0.,0.);
	SetKeyFrame(65,slHandKeyFrameValues, slHandKeyFramePositions, &slHandNumOfKeyFrames, 0.,0.,0.,1.,1.,1.,0.,0.,-90.);
	SetKeyFrame(70,slHandKeyFrameValues, slHandKeyFramePositions, &slHandNumOfKeyFrames, 0.,0.,0.,1.,1.,1.,0.,0.,-90.);

	// keyframes for the hands
	SetKeyFrame(62,srHandKeyFrameValues, srHandKeyFramePositions, &srHandNumOfKeyFrames, 0.,0.,0.,1.,1.,1.,0.,0.,0.);
	SetKeyFrame(65,srHandKeyFrameValues, srHandKeyFramePositions, &srHandNumOfKeyFrames, 0.,0.,0.,1.,1.,1.,0.,0.,90.);
	SetKeyFrame(70,srHandKeyFrameValues, srHandKeyFramePositions, &srHandNumOfKeyFrames, 0.,0.,0.,1.,1.,1.,0.,0.,90.);

	// Camera key frames
	SetKeyFrame(0,camKeyFrameValues, camKeyFramePositions, &camNumOfKeyFrames, 8.,7.,17.,1.,1.,1.,0.,0.,0.);
	SetKeyFrame(30,camKeyFrameValues, camKeyFramePositions, &camNumOfKeyFrames, 8.,7.,17.,1.,1.,1.,0.,0.,90.);
	SetKeyFrame(50,camKeyFrameValues, camKeyFramePositions, &camNumOfKeyFrames, 16.,5.,12.,1.,1.,1.,0.,0.,90.);
	SetKeyFrame(70,camKeyFrameValues, camKeyFramePositions, &camNumOfKeyFrames, 16.,5.,12.,1.,1.,1.,0.,0.,90.);
