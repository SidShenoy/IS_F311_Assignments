...
int pos;
int genNextTreeString(char* treeString){
...
void Display(void)
{
	...
	int gen = 3;			// setting the generation of the tree to be drawn
	char mainString[1000000]="0";
	for(i=0;i<=gen;i++)
		genNextTreeString(mainString);

	pos = 0;			// pos attribute to store how much of the tree has been traversed till now

	Display2(1,90.0,250.0,50.0,mainString); // Initial call to recursive function 'Display2'	
